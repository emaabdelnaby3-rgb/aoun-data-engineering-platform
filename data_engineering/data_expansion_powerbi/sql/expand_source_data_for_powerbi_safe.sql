...
DECLARE @OrgCode NVARCHAR(3) = N'101';
DECLARE @RunTag NVARCHAR(30) = FORMAT(GETDATE(), 'yyyyMMddHHmmss');

PRINT 'SAFE expanding source data for charity_food_bank_operational';
...
DECLARE @OrgCode NVARCHAR(3) = N'102';
DECLARE @RunTag NVARCHAR(30) = FORMAT(GETDATE(), 'yyyyMMddHHmmss');

PRINT 'SAFE expanding source data for charity_resala_operational';
...
DECLARE @OrgCode NVARCHAR(3) = N'103';
DECLARE @RunTag NVARCHAR(30) = FORMAT(GETDATE(), 'yyyyMMddHHmmss');

PRINT 'SAFE expanding source data for charity_haya_karima_operational';
