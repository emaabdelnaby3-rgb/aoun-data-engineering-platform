...
DECLARE @Prefix NVARCHAR(20) = N'FB';
DECLARE @OrgSk INT = 1;
DECLARE @OrgCode NVARCHAR(50) = N'food_bank';
DECLARE @OrgName NVARCHAR(100) = N'Food Bank';
DECLARE @DemoTag NVARCHAR(30) = N'DEMO2026';

PRINT 'Cleaning old demo story pack for charity_food_bank_operational';
...
PRINT 'Inserting demo story pack for charity_food_bank_operational';
...
DECLARE @Prefix NVARCHAR(20) = N'RES';
DECLARE @OrgSk INT = 2;
DECLARE @OrgCode NVARCHAR(50) = N'resala';
DECLARE @OrgName NVARCHAR(100) = N'Resala';
DECLARE @DemoTag NVARCHAR(30) = N'DEMO2026';

PRINT 'Cleaning old demo story pack for charity_resala_operational';
...
PRINT 'Inserting demo story pack for charity_resala_operational';
...
DECLARE @Prefix NVARCHAR(20) = N'HK';
DECLARE @OrgSk INT = 3;
DECLARE @OrgCode NVARCHAR(50) = N'haya_karima';
DECLARE @OrgName NVARCHAR(100) = N'Haya Karima';
DECLARE @DemoTag NVARCHAR(30) = N'DEMO2026';

PRINT 'Cleaning old demo story pack for charity_haya_karima_operational';
...
PRINT 'Inserting demo story pack for charity_haya_karima_operational';
